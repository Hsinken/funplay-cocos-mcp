...
Generated from `lib/tool-registry.js`. The default `core` profile exposes 38 tools; the `full` profile exposes 103 tools.
...
| `full` | 103 | All built-in tools, including destructive and low-level helpers. |
